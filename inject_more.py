...
p_css = pathlib.Path('assets/theme.css')
css_lines = p_css.read_text(encoding='utf-8').splitlines()
start_css = next((i for i, l in enumerate(css_lines) if '/* ---- Aura Tiers ---- */' in l), -1)
...
new_score_info = """    def _score_info(score: "Optional[int]"):
        ...
        aura = ""
        if s >= 96:
            nc, ns, aura = "#a5f3fc", "0 0 10px #a5f3fc, 0 0 22px rgba(99,102,241,0.7)", "aura-god"
            ...
            nc, ns, aura = "#fb7185", "0 0 8px rgba(251,113,133,0.9), 0 0 18px rgba(190,18,60,0.6)", "aura-ruby"
            ...
            nc, ns, aura = "#60a5fa", "0 0 8px rgba(96,165,250,0.9), 0 0 18px rgba(29,78,216,0.6)", "aura-sapphire"
            ...
            nc, ns, aura = "#c084fc", "0 0 8px rgba(192,132,252,0.9), 0 0 16px rgba(126,34,206,0.5)", "aura-amethyst"
            ...
            nc, ns, aura = "#34d399", "0 0 8px rgba(52,211,153,0.9), 0 0 16px rgba(5,150,105,0.5)", "aura-emerald"
            ...
            nc, ns, aura = "#fbbf24", "0 0 8px rgba(251,191,36,0.9), 0 0 18px rgba(217,119,6,0.5)", "aura-gold"
            ...
            nc, ns, aura = "#fcd34d", "0 0 6px rgba(252,211,77,0.8), 0 0 14px rgba(180,135,6,0.4)", "aura-topaz"
            ...
            nc, ns, aura = "#cbd5e1", "0 0 6px rgba(203,213,225,0.8)", "aura-silver"
            ...
            nc, ns, aura = "#22d3ee", "0 0 7px rgba(34,211,238,0.85), 0 0 14px rgba(8,145,178,0.5)", "aura-aqua"
            ...
            nc, ns, aura = "#b5c4a1", "0 0 5px rgba(181,196,161,0.6)", "aura-jade"
            ...
            nc, ns, aura = "#f87171", "0 0 6px rgba(185,28,28,0.7)", "aura-garnet"
            ...
            ns = f"0 0 5px rgba({r2},{g2},{b2},0.6)"
            aura = "aura-onyx"
        ...
        if s >= 96:
            ...
            aura_xml = f'''
                <g filter="url(#glow-filter)">
                    <polygon points="{make_spiky_burst('#3b82f6', 36, 18, 16)}" fill="#60a5fa" opacity="0.6"><animateTransform attributeName="transform" type="rotate" from="0 24 24" to="360 24 24" dur="4s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.3;0.8;0.3" dur="1s" repeatCount="indefinite"/></polygon>
                    <polygon points="{make_spiky_burst('#a5f3fc', 30, 20, 12)}" fill="#a5f3fc" opacity="0.8"><animateTransform attributeName="transform" type="rotate" from="360 24 24" to="0 24 24" dur="3s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.8;0.4;0.8" dur="0.8s" repeatCount="indefinite"/></polygon>
                </g>
                <circle cx="24" cy="24" r="28" fill="none" stroke="{border}" stroke-width="1.5" opacity="0.8"><animate attributeName="r" values="24;40" dur="1s" repeatCount="indefinite" /><animate attributeName="opacity" values="0.8;0" dur="1s" repeatCount="indefinite" /></circle>
            '''
        elif s >= 94:
            ...
            aura_xml = f'''
                <g filter="url(#glow-filter)">
                    <polygon points="{make_spiky_burst('#e11d48', 34, 16, 14)}" fill="#e11d48" opacity="0.7"><animateTransform attributeName="transform" type="rotate" from="0 24 24" to="360 24 24" dur="5s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.4;0.9;0.4" dur="1.2s" repeatCount="indefinite"/></polygon>
                    <polygon points="{make_spiky_burst('#fb7185', 28, 20, 8)}" fill="#fb7185" opacity="0.9"><animateTransform attributeName="transform" type="rotate" from="360 24 24" to="0 24 24" dur="2.5s" repeatCount="indefinite"/></polygon>
                </g>
            '''
        elif s >= 90:
            ...
            aura_xml = f'''
                <g filter="url(#glow-filter)">
                    <circle cx="24" cy="24" r="24" fill="none" stroke="{border}" stroke-width="2" opacity="0.9" stroke-dasharray="8,6"><animateTransform attributeName="transform" type="rotate" from="360 24 24" to="0 24 24" dur="6s" repeatCount="indefinite"/></circle>
                    <circle cx="24" cy="24" r="27" fill="none" stroke="{glow}" stroke-width="3" opacity="0.6" stroke-dasharray="15,10"><animateTransform attributeName="transform" type="rotate" from="0 24 24" to="360 24 24" dur="4s" repeatCount="indefinite"/></circle>
                </g>
                <circle cx="24" cy="24" r="28" fill="none" stroke="{glow}" stroke-width="1.5"><animate attributeName="r" values="24;36" dur="2s" repeatCount="indefinite" /><animate attributeName="opacity" values="0.7;0" dur="2s" repeatCount="indefinite" /></circle>
            '''
        elif s >= 86:
            ...
            aura_xml = f'''
                <g filter="url(#glow-filter)">
                    <polygon points="24,0 45,12 45,36 24,48 3,36 3,12" fill="none" stroke="{glow}" stroke-width="2.5" opacity="0.8"><animateTransform attributeName="transform" type="rotate" from="0 24 24" to="360 24 24" dur="8s" repeatCount="indefinite" /><animate attributeName="opacity" values="0.3;1;0.3" dur="2s" repeatCount="indefinite" /></polygon>
                    <polygon points="24,-4 49,10 49,38 24,52 -1,38 -1,10" fill="none" stroke="{border}" stroke-width="1.5" opacity="0.6"><animateTransform attributeName="transform" type="rotate" from="360 24 24" to="0 24 24" dur="8s" repeatCount="indefinite" /></polygon>
                </g>
            '''
        elif s >= 81:
            ...
            aura_xml = f'''
                 <g filter="url(#glow-filter)">
                     <circle cx="24" cy="24" r="26" fill="none" stroke="{glow}" stroke-width="2.5" stroke-dasharray="10,8"><animateTransform attributeName="transform" type="rotate" from="0 24 24" to="360 24 24" dur="5s" repeatCount="indefinite"/></circle>
                     <circle cx="24" cy="24" r="30" fill="none" stroke="{border}" stroke-width="1" stroke-dasharray="4,8"><animateTransform attributeName="transform" type="rotate" from="360 24 24" to="0 24 24" dur="7s" repeatCount="indefinite"/></circle>
                 </g>
            '''
        elif s >= 76:
            ...
            aura_xml = f'''
                ...
                <g filter="url(#glow-filter)">
                    <polygon points="{make_spiky_burst('#f59e0b', 32, 22, 10)}" fill="#fde68a" opacity="0.6"><animateTransform attributeName="transform" type="rotate" from="0 24 24" to="360 24 24" dur="6s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.4;0.9;0.4" dur="1.5s" repeatCount="indefinite"/></polygon>
                    <circle cx="24" cy="24" r="25" fill="none" stroke="{glow}" stroke-width="2" stroke-dasharray="6,4"><animateTransform attributeName="transform" type="rotate" from="360 24 24" to="0 24 24" dur="4s" repeatCount="indefinite"/></circle>
                </g>
            '''
        elif s >= 71:
            ...
            aura_xml = f'''
                <!-- Geo / Earth rings -->
                <g filter="url(#glow-filter)">
                    <rect x="-2" y="-2" width="52" height="52" fill="none" stroke="{glow}" stroke-width="1.5" transform="rotate(45 24 24)" opacity="0.6"><animateTransform attributeName="transform" type="rotate" from="45 24 24" to="225 24 24" dur="10s" repeatCount="indefinite"/></rect>
                    <rect x="2" y="2" width="44" height="44" fill="none" stroke="{border}" stroke-width="1" transform="rotate(15 24 24)" opacity="0.5"><animateTransform attributeName="transform" type="rotate" from="15 24 24" to="-165 24 24" dur="8s" repeatCount="indefinite"/></rect>
                </g>
            '''
        elif s >= 66:
            ...
            aura_xml = f'''
                <!-- Chrome Starburst -->
                <g filter="url(#glow-filter)">
                    <polygon points="{make_spiky_burst('#cbd5e1', 35, 23, 4)}" fill="#e2e8f0" opacity="0.4"><animateTransform attributeName="transform" type="rotate" from="0 24 24" to="360 24 24" dur="12s" repeatCount="indefinite"/></polygon>
                    <polygon points="{make_spiky_burst('#94a3b8', 35, 23, 4)}" fill="none" stroke="#f1f5f9" stroke-width="1" opacity="0.5" transform="rotate(45 24 24)"><animateTransform attributeName="transform" type="rotate" from="45 24 24" to="-315 24 24" dur="12s" repeatCount="indefinite"/></polygon>
                </g>
            '''
        elif s >= 61:
            ...
            aura_xml = f'''
                <!-- Water ripples -->
                <circle cx="24" cy="24" r="20" fill="none" stroke="{border}" stroke-width="1"><animate attributeName="r" values="20;32" dur="2s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.6;0" dur="2s" repeatCount="indefinite"/></circle>
                <circle cx="24" cy="24" r="20" fill="none" stroke="{glow}" stroke-width="1" begin="1s"><animate attributeName="r" values="20;32" dur="2s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.6;0" dur="2s" repeatCount="indefinite"/></circle>
            '''
        elif s >= 56:
            ...
            aura_xml = f'''
                ...
                <circle cx="24" cy="24" r="25" fill="none" stroke="{glow}" stroke-width="2" stroke-dasharray="12,16"><animateTransform attributeName="transform" type="rotate" from="0 24 24" to="360 24 24" dur="3s" repeatCount="indefinite"/></circle>
            '''
        elif s >= 50:
            ...
            aura_xml = f'''
                <!-- Embers pulsing -->
                <polygon points="{make_spiky_burst('#b91c1c', 28, 22, 6)}" fill="#f87171" opacity="0.3"><animateTransform attributeName="transform" type="rotate" from="0 24 24" to="360 24 24" dur="15s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.1;0.5;0.1" dur="2s" repeatCount="indefinite"/></polygon>
            '''
        elif s >= 40:
...
# Now write back to tracker/page.py
...
@keyframes auraPulseGold {
  0% { text-shadow: 0 0 8px #fbbf24, 0 0 15px #d97706; }
  50% { text-shadow: 0 0 12px #fde68a, 0 0 25px #b45309; }
  100% { text-shadow: 0 0 8px #fbbf24, 0 0 15px #d97706; }
}
.aura-gold { animation: auraPulseGold 3s ease-in-out infinite; color: #fbbf24; }

@keyframes auraPulseTopaz {
  0% { text-shadow: 0 0 6px #fcd34d, 0 0 12px #b45309; }
  50% { text-shadow: 0 0 10px #fef3c7, 0 0 20px #92400e; }
  100% { text-shadow: 0 0 6px #fcd34d, 0 0 12px #b45309; }
}
.aura-topaz { animation: auraPulseTopaz 3.5s ease-in-out infinite; color: #fcd34d; }

@keyframes auraPulseSilver {
  0% { text-shadow: 0 0 6px #cbd5e1, 0 0 10px #64748b; }
  50% { text-shadow: 0 0 10px #f1f5f9, 0 0 16px #475569; }
  100% { text-shadow: 0 0 6px #cbd5e1, 0 0 10px #64748b; }
}
.aura-silver { animation: auraPulseSilver 4s ease-in-out infinite; color: #cbd5e1; }

@keyframes auraPulseAqua {
  0% { text-shadow: 0 0 6px #22d3ee, 0 0 12px #0891b2; }
  50% { text-shadow: 0 0 10px #a5f3fc, 0 0 18px #0e7490; }
  100% { text-shadow: 0 0 6px #22d3ee, 0 0 12px #0891b2; }
}
.aura-aqua { animation: auraPulseAqua 3.5s ease-in-out infinite; color: #22d3ee; }

@keyframes auraPulseJade {
  0% { text-shadow: 0 0 5px #b5c4a1, 0 0 10px #4a7c40; }
  50% { text-shadow: 0 0 8px #dcfce7, 0 0 15px #2d4a24; }
  100% { text-shadow: 0 0 5px #b5c4a1, 0 0 10px #4a7c40; }
}
.aura-jade { animation: auraPulseJade 4s ease-in-out infinite; color: #b5c4a1; }

@keyframes auraPulseGarnet {
  0% { text-shadow: 0 0 5px #f87171, 0 0 10px #991b1b; }
  50% { text-shadow: 0 0 8px #fee2e2, 0 0 16px #7f1d1d; }
  100% { text-shadow: 0 0 5px #f87171, 0 0 10px #991b1b; }
}
.aura-garnet { animation: auraPulseGarnet 4s ease-in-out infinite; color: #f87171; }

.aura-god { color: #a5f3fc; }
.aura-ruby { color: #fb7185; }
.aura-sapphire { color: #60a5fa; }
.aura-amethyst { color: #c084fc; }
.aura-emerald { color: #34d399; }
"""

if start_css != -1:
    new_css = css_lines[:start_css+1] + css_addition.splitlines() + css_lines[start_css+1:]
    p_css.write_text('\n'.join(new_css), encoding='utf-8')
    print("Injected CSS")
else:
    print("CSS tag not found - appending")
